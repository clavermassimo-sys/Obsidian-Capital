    ...
    >
      ...
      <div className="flex flex-col items-center py-8 px-6 border-b border-border">
        <div className="mb-3">
          ...
          >
            ...
            {/* Center diamond */}
            <polygon
              points="24,16 31,24 24,32 17,24"
              fill="#c9a84c"
              fillOpacity="0.7"
            />
            {/* Center dot */}
        ...
        <div className="text-center">
          <div
            className="font-serif text-sm font-semibold tracking-[0.15em] text-off-white uppercase"
          ...
          >
            {({ isActive }) => (
              <>
                <Icon
                  size={17}
                  className={isActive ? 'text-gold' : 'text-off-white/50'}
                />
                <span>{label}</span>
              </>
            )}
      ...
      <div className="px-4 py-5 border-t border-border">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <div className="text-xs font-semibold text-off-white">
              Admin User
            </div>
            <div className="text-xs text-off-white/40">admin@obsidian.com</div>
          </div>
        </div>
        <button
          onClick={() => navigate('/')}
